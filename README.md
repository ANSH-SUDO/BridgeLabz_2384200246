...
03-03-25
        ...
        1. Redis Concept
        2. Implementing Redis in web api
        3. Testing api through postman

---------------------------------------------------------------------------------------------------------------------------
04-03-25

        1. RabbitMQ Concept
        2. Implementing RabbitMQ in web api
        3. Testing api through postman
...
17-03-25
        ...
        2. Creating first file using JS
        3. Control Flow Statements
        4. Random Numbers Operations

---------------------------------------------------------------------------------------------------------------------------
18-03-25

        1. Creating logic in JS
        2. Solved Assignment
...
19-03-25
        ...
        1. Angular Basics
        2. How to implement angular in html

---------------------------------------------------------------------------------------------------------------------------
20-03-25

        1. Flex-box Concept
        2. Card Creation using css
