...
public class LargestNum
{
    ...
    public static void Main()
    {
        ...
        Console.WriteLine("Is the first number the largest? {0}", firstResult);
		Console.WriteLine("Is the second number the largest? {0}", secondResult);
		Console.WriteLine("Is the third number the largest? {0}", thirdResult);
